...
#train_labels = train_labels[8000:16000] 
#train_labels = train_labels[16000:24000]
#train_labels = train_labels[24000:32000]
#train_labels = train_labels[32000:40000]
#train_labels = train_labels[40000:48000]
#train_labels = train_labels[48000:56000]
...
#train_images = np.reshape(train_images.copy(),[800,32,32,3])
    ...
    with autodist.create_distributed_session() as sess:
        for epoch in range(EPOCHS):
            ...
            for _ in range(train_steps_per_epoch):
                ...
                prediction, prediction_hat = sess.run(test_fetches, {x: train_images[0:400], y: train_labels[0:400]})
                ...
                prediction, prediction_hat = sess.run(test_fetches, {x: test_images[0:400], y: test_labels[0:400]})
                prediction = keras.utils.to_categorical(prediction, 10)
                correct_prediction = tf.equal(tf.round(prediction_hat), prediction)
